      ...
      <div class="row">
        <div class="col-md-3">
          <div class="list-group">
              ...
              <a href="{{ route('contacts.index') }}" class="list-group-item {{ empty($selected_group) ? 'active' : '' }}">All Contact <span class="badge">{{ $contactsCount->count() }}</span></a>
